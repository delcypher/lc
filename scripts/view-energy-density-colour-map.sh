#!/bin/bash
#Bash script to simplify calling GNUplot script (energy-den-colour-map.gnu) to view a binary state file.
...
gnuplot <(echo "set term x11; call \"${SCRIPTS_PATH}/energy-den-colour-map.gnu\" \"${TEMP_FILE}\" ${WIDTH} ${HEIGHT}") -
