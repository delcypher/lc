#!/bin/bash
#Script to build a set binary state files to simulated on a torque/PBS cluster
...
#Check we're running on correct machine
if [ "$(hostname)" != "calgary.phy.bris.ac.uk" ]; then
