...
#include "differentiate.h"
	...
	__device__ double dNxdx_F(const LatticeObject* l, int xPos, int yPos)
	{
	...
	__device__ double dNxdx_B(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
	...
	__device__ double dNxdy_F(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
	...
	__device__ double dNxdy_B(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
	...
	__device__ double dNydx_F(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
	...
	__device__ double dNydx_B(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
	...
	__device__ double dNydy_F(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
	...
	__device__ double dNydy_B(const LatticeObject* l, int xPos, int yPos)
	{
		/*see if we need to flip directorElement to make sure angle between
		* vectors is < 90deg so if cos(theta) < 0 then we should flip directorElement by 180degress
		*/
